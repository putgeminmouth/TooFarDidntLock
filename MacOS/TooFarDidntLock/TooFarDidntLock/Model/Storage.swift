...
extension BluetoothLinkModel: DictionaryRepresentable {
    ...
    static func fromDict(_ dict: [String: Any?]) -> BluetoothLinkModel? {
        guard let idString = dict["id"] as? String,
              ...
              let environmentalPathLoss = (dict["environmentalPathLoss"] as? NSNumber)?.doubleValue,
              ...
              let linkStateDebounce = (dict["linkStateDebounce"] as? NSNumber)?.doubleValue
        else { return nil }
        return BluetoothLinkModel(
            ...
            environmentalPathLoss: environmentalPathLoss,
            ...
            linkStateDebounce: linkStateDebounce
        )
    }
}
